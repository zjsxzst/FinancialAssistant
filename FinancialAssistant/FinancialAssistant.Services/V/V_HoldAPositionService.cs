...
namespace FinancialAssistant.Services.V
{
    ...
    {
        public IList<V_HoldAPosition> GetData(int pageSize, int pageIndex, ref int pageNum,string Where/*, ref int TotalPages*/)
        {
            string sql = string.Format("SELECT * FROM V_HoldAPosition {0}", Where);
